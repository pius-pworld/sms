...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `requester_phone` varchar(255) COLLATE utf8_bin NOT NULL,
  `dh_name` varchar(255) COLLATE utf8_bin NOT NULL,
  `dh_phone` varchar(255) COLLATE utf8_bin NOT NULL,
  `tso_name` varchar(255) COLLATE utf8_bin NOT NULL,
  `tso_phone` varchar(255) COLLATE utf8_bin NOT NULL,
  `route_name` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `total_outlet` int(11) NOT NULL,
  `visited_outlet` int(11) NOT NULL,
...
-- Dumping data for table larafremworktestdb.orders: 0 rows
...
-- Dumping data for table larafremworktestdb.order_details: 0 rows
...
-- Dumping data for table larafremworktestdb.sales: 0 rows
...
-- Dumping data for table larafremworktestdb.sale_details: 0 rows
...
-- Dumping data for table larafremworktestdb.sms_inboxes: ~1 rows (approximately)
