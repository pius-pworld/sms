...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Order VS Sale Secondary By ASO
            </h1>
            {!! $breadcrumb !!}
        </section>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header" style="overflow: hidden">
                        <span class="box-title" style="float: left;">Order Vs Sale Secondary By ASO</span>
                    ...
                    <div class="box-body showSearchDataUnique" style="overflow: scroll;">
                        @include('reports.order_vs_sale_secondary_aso_ajax')
                    </div>
